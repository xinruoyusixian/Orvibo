...
class bfMqtt:
    ...
    def __init__(self, client_id,topic,cb, keepalive=0):
    ...
    def publish(self,msg, retain=False, qos=0):
        pkt = bytearray(b"\x30\0\0\0")
        pkt[0] |= qos << 1 | retain
        sz = 2 + len(self.topic) + len(msg)
        if qos > 0:
            sz += 2
        assert sz < 2097152
        i = 1
...
if __name__=="__main__":
  ...
  lib.update_time()
  mq=bfMqtt("d023980739a4c6d611f59b9e351b791c","power001",p_data)
  mq.connect()
  while 1:
